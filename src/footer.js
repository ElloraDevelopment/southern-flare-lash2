        ...
        return (
            <div className="footer">
                <div className='align-left'>
                    ...
                    <div><a className="footer-links footer-inline" target="_blank" href="https://www.Elloradev.com">Copyright  &copy; 2017 <span className='ellora-dev'>Ellora Dev</span></a></div>
                </div>
